...
** System packages
   ...
   - [[https://git-scm.com][git]] :: Used by Magit for [[version-control]].
   - [[https://github.com/ggreer/the_silver_searcher][ag]], rg, git grep or grep :: Used by Dumb-jump for [[code navigation]].
   - [[https://prettier.io/][prettier]] :: Used to prettify HTML & JS code upon save. See: [[development]].
   - [[https://fletcherpenney.net/multimarkdown/][multimarkdown]] :: Used for [[markdown-mode]].
   - [[https://internal1.languagetool.org/snapshots/][languagetool-commandline.jar]] :: Used for [[grammar check]].
   - [[https://pygments.org/][Pygments]] :: Used for [[code syntax highlighting]].
...
*** grammar check
    - [[https://github.com/mhayashi1120/Emacs-langtool][langtool]] :: provides an Emacs interface to =LanguageTool= (pre-configured)
      ...
      - Modify the =config/00-packages.el= to point to your =languagetool-commandline.jar=
...
** Further Customizations
   ...
   =~/.emacs.d/config/00-packages.el= file.
